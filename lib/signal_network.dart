          ...
          child: Column(
            children: <Widget>[
              ...
              GFAccordion(
                ...
                expandedIcon: Icon(Icons.minimize),
                title:
                    "Learn how to do if phone has water or other liquid damage accidentally",
                content:
              ...
              GFAccordion(
                ...
                content:
                    "Press the Menu button. Slide down the application interface until you see a lock icon at the left upper corner.",
              ),
              GFAccordion(
                textStyle: TextStyle(fontSize: 20),
                titleBorderRadius: BorderRadius.circular(20),
              ...
              GFAccordion(
                ...
                content:
                    "Press and hold the Power and Volume Down buttons: Your phone will take a screenshot for the current page. Press and hold the Power and Volume Up buttons about 2 seconds to capture a long screenshot.Click [Page-down] to scroll to the next page, continue to click Page-down until you want to stop capturing, then click [Save] to generate a long screenshot.",
              ),
              GFAccordion(
                textStyle: TextStyle(fontSize: 20),
                titleBorderRadius: BorderRadius.circular(20),
              ...
              GFAccordion(
                ...
                content:
                    "When the phone stops functioning properly in certain cases (such as fails to restart or switch off, update the system, wipe data ), you can fix the issues under Recovery Mode.After your phone turns off, press and hold both the Power and Volume Down buttons, until the phone enters Recovery Mode.You can download the firmware to your phone storage, then click [Install from storage device] > [From phone storage], find the firmware you’ve downloaded and click it to start updating. * Back up your data before updating the system. * Plug your phone into power or keep the battery level over 40%. * System update takes 3-5mins. Do not force power off your phone during the update.",
              ),
              GFAccordion(
                textStyle: TextStyle(fontSize: 20),
                titleBorderRadius: BorderRadius.circular(20),
